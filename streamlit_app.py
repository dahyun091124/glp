...
<head>
    ...
    <title>GLP 2조 | 소비 가이드북 & MANUS</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;700&display=swap');
        body {
            font-family: 'Noto Sans KR', sans-serif;
            background-color: #fcfbf7; /* 브로셔 특유의 따뜻한 아이보리 톤 */
        }
...
<body class="text-gray-800">
    ...
    <header class="sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="#manus-app" class="bg-accent text-white px-4 py-2 rounded-full text-xs font-semibold hover:bg-amber-800 transition">
                앱 다운로드
            </a>
        </div>
    </header>
    ...
    <section id="intro" class="max-w-6xl mx-auto px-4 py-16 text-center">
        <span class="text-xs font-bold uppercase tracking-widest bg-amber-100 text-amber-800 px-3 py-1 rounded-full">소비 가이드북 : 특별편</span>
        ...
        <div class="mt-8 flex justify-center gap-4">
            ...
            <a href="#manus-app" class="bg-accent text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-amber-800 transition shadow-lg shadow-amber-900/20">MANUS 만나기</a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center">
                ...
                <div class="flex items-end space-x-6 h-48 w-full justify-center px-4 border-b border-gray-200">
                    ...
                    <div class="flex flex-col items-center w-12"><div class="bg-amber-600/60 w-full rounded-t" style="height: 25%;"></div><span class="text-xs mt-2 font-medium">여가</span></div>
                    <div class="flex flex-col items-center w-12"><div class="bg-amber-600/40 w-full rounded-t" style="height: 12%;"></div><span class="text-xs mt-2 font-medium">의류</span></div>
                    <div class="flex flex-col items-center w-12"><div class="bg-amber-600/20 w-full rounded-t" style="height: 5%;"></div><span class="text-xs mt-2 font-medium">교육</span></div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center">
                ...
                <div class="flex items-end space-x-6 h-48 w-full justify-center px-4 border-b border-gray-200">
                    ...
                    <div class="flex flex-col items-center w-12"><div class="bg-amber-600/60 w-full rounded-t" style="height: 42%;"></div><span class="text-xs mt-2 font-medium">마두</span></div>
                    <div class="flex flex-col items-center w-12"><div class="bg-amber-600/30 w-full rounded-t" style="height: 22%;"></div><span class="text-xs mt-2 font-medium">집 동네</span></div>
                </div>
            </div>
        </div>
    </section>

    <section id="fleamarket" class="bg-stone-100 py-16">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center max-w-4xl mx-auto">
                <div class="bg-amber-50 p-6 rounded-2xl border border-amber-200/60 flex items-center justify-center min-h-[250px]">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                        <span class="bg-amber-700 text-white text-[10px] px-2 py-0.5 rounded font-bold">2</span>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">폐방화복을 활용해 가방과 액세서리를 제작하고, 그 수익금을 통해 암 투병 소방관을 지원하는 사회적 기업입니다.</p>
                    </div>
                    <div class="border-t border-dashed my-4"></div>
                    <div>
                        <h4 class="font-bold text-base">4. 노플라스틱선데이</h4>
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">버려지는 플라스틱을 수거해 생활용품으로 재탄생시키는 업사이클링 브랜드입니다.</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">자연에서 얻은 신선한 재료와 동물 실험을 하지 않는 정직한 재료를 사용하여 모든 제품을 손으로 만듭니다. 성분의 90%는 식물성 원료인 비건입니다.</p>
                    </div>
                    <div class="border-t border-dashed my-4"></div>
                    <div>
                        <h4 class="font-bold text-base">2. 신이어마쾍</h4>
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">폐지 수거 노인을 넘어 일하고 싶은 시니어까지 즐겁고 따뜻한 일자리로 청년과 노년이 함께 일하는 브랜드입니다.</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">용기를 재사용하여 세제, 샴푸, 화장품 등의 내용물만 소분 구매하는 친환경 매장 (예: 아모레퍼시픽, 아로마티카)</p>
                    </div>
                    <div class="border-t border-dashed my-4"></div>
                    <div>
                        <h4 class="font-bold text-base">2. 플리츠 마마</h4>
                        <p class="text-xs text-gray-600 mt-2 leading-relaxed">페트병 리사이클 원사로 니트 가방을 제작하는 국내 친환경 패션 브랜드입니다.</p>
                    </div>
                </div>
                <div class="mt-6 text-2xl text-right">🧴👜</div>
            </div>
    ...
    <section id="manus-app" class="bg-stone-900 text-white py-20">
        <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                <span class="text-xs font-bold uppercase tracking-widest bg-amber-500/20 text-amber-400 px-3 py-1 rounded-full">Next-Gen Lifestyle App</span>
                <h2 class="text-3xl md:text-4xl font-bold tracking-tight leading-tight">
                    나의 가치 소비와 일상을<br>
                    <span class="text-amber-400">MANUS</span> 에 기록하세요
                </h2>
                ...
                <div class="pt-4">
                    <a href="https://manus.im/app-preview/i7zPuB3unvW8Ks9MGw6dVT?sessionId=bjA7pGHJXXQ7LHfXgBiYgW" target="_blank" class="inline-flex items-center gap-2 bg-amber-500 text-neutral-900 px-6 py-3 rounded-xl font-bold text-sm hover:bg-amber-400 transition shadow-lg shadow-amber-500/20">
                        📱 MANUS 앱 미리보기/다운로드
                    </a>
                </div>
            </div>
            <div class="flex justify-center">
                <div class="relative bg-stone-800 w-64 h-[500px] rounded-[40px] border-[6px] border-stone-700 shadow-2xl overflow-hidden flex flex-col justify-between p-6">
                    <div class="w-20 h-4 bg-stone-700 rounded-full mx-auto mb-4"></div>
                    <div class="flex-1 flex flex-col justify-center items-center text-center space-y-4">
                        <span class="text-4xl">✨</span>
                        <h4 class="font-bold text-lg">MANUS</h4>
                        <p class="text-[11px] text-stone-400 px-2">당신의 가치 있는 하루를 한눈에 정리하는 스마트 라이프 앱</p>
                        <div class="bg-stone-700/50 text-[10px] py-1.5 px-4 rounded-full text-amber-300">지금 연동하고 시작하기</div>
                    </div>
                    <div class="text-[9px] text-center text-stone-500">© 2026 MANUS All rights reserved.</div>
                </div>
            </div>
        </div>
    </section>

    <footer class="bg-stone-950 text-stone-500 text-xs py-8 border-t border-stone-900">
        <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <p class="font-medium text-stone-400">GLP 2조 | 지속 가능한 소비 프로젝트</p>
                <p class="mt-1">본 페이지는 브로셔 배포 및 가치 실천 확산을 위해 제작되었습니다.</p>
            </div>
            <div class="flex space-x-4">
                <a href="#intro" class="hover:underline">맨 위로</a>
